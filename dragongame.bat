...
if '%choose%'=='2' goto store
if '%choose%'=='3' goto menu
if '%choose%'=='4' goto nextx
goto start
...
echo.
set /p again= Kies: 
if %again%==1 goto buysword
if %again%==2 goto buyheal
if %again%==3 goto start
goto store
